        ...
        <div class="question_footer" v-on:change=saveChanges>
            <div>
                <div>
                    ...
                    <input v-model="questionData.correctA" type="radio" name="correctAnswer">
                </div>
                <div>
...
export default {
    ...
    methods: {
        saveChanges() {
            console.log(this.questionData.correctA);
            var data = {
                id:this.id,
                title:this.questionData.title,
                answerA: this.questionData.answerA,
                answerB: this.questionData.answerB,
                answerC: this.questionData.answerC,
                answerD: this.questionData.answerD,
            }
            bus.$emit("saveQuestion", data)
