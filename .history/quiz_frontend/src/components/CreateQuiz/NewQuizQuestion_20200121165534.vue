        ...
        <div class="question_footer">
            <div>
                <div>
                    ...
                    <input v-model="data.correctA" :value="data.correctA=!data.correctA" type="radio" name="correctAnswer">
                </div>
                <div>
                    <input v-model="data.answerB" type="text" placeholder="Answer B">
                    <input v-model="data.correctB" :value="data.correctB=!data.correctB" type="radio" name="correctAnswer">
                </div>
            </div>
            <div>
                <div>
                ...
                <div>
                    ...
                    <input v-model="data.correctD" value="true" type="radio" name="correctAnswer">
                </div>
            </div>
        </div>
    </div>
...
export default {
    ...
    methods: {
        saveChanges() {
            console.log(this.data.correctA);
            console.log(this.data.correctB);
            var sendData = {
                id:this.id,
